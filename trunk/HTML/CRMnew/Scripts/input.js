    ...
    $.extend(Plugin.prototype, {
        ...
        buildInputBoxes: function () {
            ...
            for (var i = 0; i < this.settings.inputs; i++) {
                if (i == 0) {
                    var input = $('<input>').attr({ 'type': 'password', 'maxlength': "1", 'autocomplete': 'off', 'id': 'firstInput' }).addClass('form-control pincode-input-text').appendTo(this._container);
                }
                else {
                ...
                input.on('keyup', $.proxy(function (e) {
                    ...
                    if (e.keyCode == 8) {
                        ...
                        $(e.currentTarget).val($(e.currentTarget).val().replace(/\D/gi, ""));
