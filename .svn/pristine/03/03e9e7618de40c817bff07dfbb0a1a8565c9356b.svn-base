function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#2ccbd3","bg_over":"#EFEFEF","bg_out":"#FFCC00"}
};
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background:#fff;border:1px solid #dbe1e8;width:220px;height:243px;">');
...
__ci.document.writeln('body {font-size:12px;margin:0px;text-align:center;font-family: Arial, Helvetica,"\5FAE\8F6F\96C5\9ED1", "\5B8B\4F53", "\9ED1\4F53", sans-serif;}');
__ci.document.writeln('form {margin:0px;}');
__ci.document.writeln('select {font-size:12px;background:#EFEFEF;}');
__ci.document.writeln('table {border:0px solid #ccc;background-color:#fff}');
__ci.document.writeln('th {font-size:12px;font-weight:normal;background-color:#fff;}');
__ci.document.writeln('th.theader {font-weight:normal;background:#eaedf1;width:24px;}');
__ci.document.writeln('select.year {width:64px;}');
__ci.document.writeln('select.month {width:60px;}');
__ci.document.writeln('td {font-size:12px;text-align:center; height:20px}');
__ci.document.writeln('td.sat {color:#00f;background-color:#EFEFEF;}');
__ci.document.writeln('td.sun {color:#f00;background-color:#EFEFEF;}');
__ci.document.writeln('td.normal {background-color:#EFEFEF;}');
__ci.document.writeln('input.l {border: 1px solid #ccc;background-color:#EFEFEF;width:20px;height:20px;}');
__ci.document.writeln('input.r {border: 1px solid #ccc;background-color:#EFEFEF;width:20px;height:20px;}');
__ci.document.writeln('input.b {border: 1px solid #ccc;background-color:#EFEFEF;width:100%;height:20px;}');
__ci.document.writeln('-->');
